//Programa que permita ingresar los elementos sin repeticion en una lista y obtener 
//el MCD del primer y ultimo dato de sus respecrivos nodos  en tiempo real.

...
public:												// métodos públicos de la clase GrafoMatriz
	...
	int getNumVertice(Tipo v);						//devuelve el numero de vertice conociendo su valor
...
void GrafoLista::setVertice(Tipo a, Vertice v) {			//modifica los atributos de un vertice, conociendo su numero
...
int GrafoLista::getNumVertice(Tipo v) {						//determina el numero de un vertice dentro del grafo, conociendo su valor
...
void GrafoLista::nuevoVertice(Tipo v) {						//crea un nuevo vertice recibiendo su valor
...
bool GrafoLista::adyacente(Tipo a, Tipo b) {				//determina si dos vertices forman un arco conociendo su nombre
	int va, vb;												//variables para contener numeros de los vertices recibidos por nombre	va = getNumVertice(a);									//calcula numero de vertice del primer nombre recibido
	vb = getNumVertice(b);									//calcula numero de vertice del segundo nombre recibido

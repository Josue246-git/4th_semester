//Obtener una lista ordena de los vertices en funcion de su grado de entrada
...
int main(){
	...
	void Calcular_grado_entrada(GrafoLista g);
    //
    ...
    cout<<endl<<"GENERAR UNA LISTA CON VERTICES ORDENADO POR SU GRADO DE ENTRADA"<<endl;
	Calcular_grado_entrada(g);
...
GrafoLista ingresarVertices(int n1){			//funcion que ingresa los datos de los vértices de un grafo
	Tipo aux;
	GrafoLista a(n1);						//No se puede pasarle como referencia, pues no tiene el max de vetive inic

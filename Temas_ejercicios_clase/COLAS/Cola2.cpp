//Progrma para buscar un dato en la cola 
...
int main(){
    ...
    // cout<<endl<<"Ingrese le dato a buscar en la COLA: ";cin>>val;
    // cout<<endl<<" EL valor "<<val<<(Esta_en_cola(c, val )? " SI ": " NO ")<<" esta en la cola "<<endl;

    //VER SI UNA COLA ESTA COMPUESTA EN OTRA MAS GRNDE 

    cout<<endl<<" LA cola A"<<(Comprobar_colaA_enB(c,c2)? " SI ": " NO ")<<" esta en la cola B"<<endl;

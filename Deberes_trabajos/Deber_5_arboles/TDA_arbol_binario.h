...
//METODOS PARA LOS ABB
	...
	NodoBinario* eliminar (NodoBinario *rSub, Tipo v) {		//implementa la eliminacion de un nodo del AB, devuelve el arbol acutal9izado
...
NodoBinario* ArbolBinario::construirAB(Tipo dato, NodoBinario* i, NodoBinario* d){ //construye un nuevo nodo con los parametros y devuelve su direccion
